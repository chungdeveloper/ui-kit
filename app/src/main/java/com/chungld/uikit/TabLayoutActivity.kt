...
import com.chungld.uipack.tab.TrpTabLayout
...
//        tab0.getTabAt(2)?.customView = custom
        ...
        findViewById<TrpTabLayout>(R.id.tab1)?.let { tab1 ->
