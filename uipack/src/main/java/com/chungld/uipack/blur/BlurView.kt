...
import com.chungld.uipack.blur.PreDrawBlurController.Companion.TRANSPARENT
...
class BlurView : FrameLayout {
    ...
    private fun init(attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        overlayColor = a.getColor(R.styleable.BlurView_uiBlurOverlayColor, TRANSPARENT)
        a.recycle()
    }
    ...
    fun setupWith(rootView: ViewGroup, algorithm: BlurAlgorithm?): BlurViewFacade {
        ...
        val blurController: BlurController = PreDrawBlurController(
            this, rootView, overlayColor,
            algorithm!!
        )
