...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.chungld.uipack.calendar.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.chungld.uipack.calendar.WeekBar".equalsIgnoreCase(getClass().getName())) {
     ...
     */
    protected void onDateSelected(TrpCalendar calendar, int weekStart, boolean isClick) {
     ...
     */
    protected int getViewIndexByCalendar(TrpCalendar calendar, int weekStart) {
