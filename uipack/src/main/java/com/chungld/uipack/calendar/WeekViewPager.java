...
public final class WeekViewPager extends ViewPager {
     ...
     * @return 获取当前周数据
     */
    List<TrpCalendar> getCurrentWeekCalendars() {
        List<TrpCalendar> calendars = CalendarUtil.getWeekCalendars(mDelegate.mIndexCalendar,
                mDelegate);
     ...
     * 更新任意一个选择的日期
     */
    void updateSelected(TrpCalendar calendar, boolean smoothScroll) {
    ...
    private class WeekViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            TrpCalendar calendar = CalendarUtil.getFirstCalendarStartWithMinCalendar(mDelegate.getMinYear(),
                    mDelegate.getMinYearMonth(),
                    mDelegate.getMinYearDay(),
                    position + 1,
                    mDelegate.getWeekStart());
