...
final class CalendarUtil {
     ...
     */
    static boolean isWeekend(TrpCalendar calendar) {
    ...
    static int getMonthViewLineCount(int year, int month, int weekStartWith, int mode) {
        ...
        int nextDiff = com.chungld.uipack.calendar.CalendarUtil.getMonthEndDiff(year, month, weekStartWith);
        int preDiff = com.chungld.uipack.calendar.CalendarUtil.getMonthViewStartDiff(year, month, weekStartWith);
        int monthDayCount = com.chungld.uipack.calendar.CalendarUtil.getMonthDaysCount(year, month);
     ...
     */
    static int getWeekFromDayInMonth(TrpCalendar calendar, int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
     ...
     * @return 获取上一个日子
     */
    static TrpCalendar getPreCalendar(TrpCalendar calendar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        ...
        TrpCalendar preCalendar = new TrpCalendar();
    ...
    static TrpCalendar getNextCalendar(TrpCalendar calendar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        ...
        TrpCalendar nextCalendar = new TrpCalendar();
     ...
     */
    static int getMonthViewStartDiff(TrpCalendar calendar, int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        date.set(calendar.getYear(), calendar.getMonth() - 1, 1, 12, 0, 0);
     ...
     * @return 返回某个日期是星期几
     */
    static int getWeekFormCalendar(TrpCalendar calendar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
     ...
     */
    static int getWeekViewIndexFromCalendar(TrpCalendar calendar, int weekStart) {
     ...
     * @return 是否在日期范围內
     */
    static boolean isCalendarInRange(TrpCalendar calendar,
     ...
     */
    static int getWeekFromCalendarStartWithMinCalendar(TrpCalendar calendar,
                                                       int minYear, int minYearMonth, int minYearDay,
                                                       int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
     ...
     * @return 该星期的第一天日期
     */
    static TrpCalendar getFirstCalendarStartWithMinCalendar(int minYear, int minYearMonth, int minYearDay, int week, int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
     ...
     * @return 是否在日期范围内
     */
    static boolean isCalendarInRange(TrpCalendar calendar, CalendarViewDelegate delegate) {
     ...
     */
    static int differ(TrpCalendar calendar1, TrpCalendar calendar2) {
        if (calendar1 == null) {
     ...
     * @return 为月视图初始化日历项
     */
    static List<TrpCalendar> initCalendarForMonthView(int year, int month, TrpCalendar currentDate, int weekStar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        ...
        List<TrpCalendar> mItems = new ArrayList<>();
        ...
        if (month == 1) {//如果是1月
            ...
            nextYear = year;
            nextMonth = month + 1;
            preMonthDaysCount = mPreDiff == 0 ? 0 : com.chungld.uipack.calendar.CalendarUtil.getMonthDaysCount(preYear, preMonth);
        ...
        for (int i = 0; i < size; i++) {
            TrpCalendar calendarDate = new TrpCalendar();
            if (i < mPreDiff) {
            ...
            com.chungld.uipack.calendar.LunarCalendar.setupLunarCalendar(calendarDate);
            mItems.add(calendarDate);
        }
        return mItems;
    }

    static List<TrpCalendar> getWeekCalendars(TrpCalendar calendar, CalendarViewDelegate mDelegate) {
    ...
    static List<TrpCalendar> initCalendarForWeekView(TrpCalendar calendar, CalendarViewDelegate mDelegate, int weekStart) {
        ...
        TrpCalendar selectCalendar = new TrpCalendar();
        ...
        com.chungld.uipack.calendar.LunarCalendar.setupLunarCalendar(selectCalendar);
     ...
     */
    static TrpCalendar getFirstCalendarFromMonthViewPager(int position, CalendarViewDelegate delegate) {
        TrpCalendar calendar = new TrpCalendar();
        ...
        if (delegate.getDefaultCalendarSelectDay() != CalendarViewDelegate.FIRST_DAY_OF_MONTH) {
            ...
            TrpCalendar indexCalendar = delegate.mIndexCalendar;
     ...
     * @return 获取边界访问日期
     */
    static TrpCalendar getRangeEdgeCalendar(TrpCalendar calendar, CalendarViewDelegate delegate) {
        if (com.chungld.uipack.calendar.CalendarUtil.isCalendarInRange(delegate.getCurrentDay(), delegate)
        ...
        TrpCalendar minRangeCalendar = delegate.getMinRangeCalendar();
     ...
     * @return 是否是最小访问边界了
     */
    private static boolean isMinRangeEdge(TrpCalendar calendar, CalendarViewDelegate delegate) {
        java.util.Calendar c = java.util.Calendar.getInstance();
