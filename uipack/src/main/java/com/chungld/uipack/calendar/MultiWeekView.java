 ...
 */
public abstract class MultiWeekView extends com.chungld.uipack.calendar.BaseWeekView {
    ...
    public void onClick(View v) {
        ...
        if (mParentLayout != null) {
            int i = com.chungld.uipack.calendar.CalendarUtil.getWeekFromDayInMonth(calendar, mDelegate.getWeekStart());
