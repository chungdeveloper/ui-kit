 ...
 * Created by ChungLD on 2018/1/23.
 */
...
public abstract class BaseView extends View implements View.OnClickListener, View.OnLongClickListener {
    ...
    protected Paint mSelectedRangePaint = new Paint();
    ...
    private void initPaint(Context context) {
        ...
        mSelectedRangePaint.setStrokeWidth(2);
    ...
    final void updateStyle() {
        ...
        this.mSelectedPaint.setStyle(Paint.Style.FILL);
        this.mSelectedRangePaint.setColor(mDelegate.getSelectedRangeThemeColor());
    }
    ...
    final void addSchemesFromMap() {
        ...
        for (TrpCalendar a : mItems) {
            if (mDelegate.mSchemeDatesMap.containsKey(a.toString())) {
                TrpCalendar d = mDelegate.mSchemeDatesMap.get(a.toString());
                if (d == null) {
                    continue;
                }
     ...
     */
    protected boolean isSelected(TrpCalendar calendar) {
    ...
    protected final boolean isBetweenRange(TrpCalendar calendar) {
        return mDelegate != null && !calendar.equals(mDelegate.mSelectedStartRangeCalendar) && !calendar.equals(mDelegate.mSelectedEndRangeCalendar);
    }

    protected final AdditionData getAdditionData() {
        return mDelegate != null ? mDelegate.getAdditionData() : null;
    }
