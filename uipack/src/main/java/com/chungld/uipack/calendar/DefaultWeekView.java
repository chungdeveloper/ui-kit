...
/**
 * 默认高仿魅族周视图
 * Created by ChungLD on 2017/11/29.
 */

public final class DefaultWeekView extends com.chungld.uipack.calendar.WeekView {
     ...
     */
    @Override
    protected boolean onDrawSelected(Canvas canvas, TrpCalendar calendar, int x, boolean hasScheme) {
    ...
    @Override
    protected void onDrawScheme(Canvas canvas, TrpCalendar calendar, int x) {
    ...
    @Override
    protected void onDrawText(Canvas canvas, TrpCalendar calendar, int x, boolean hasScheme, boolean isSelected) {
