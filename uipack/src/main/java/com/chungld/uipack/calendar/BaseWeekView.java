...
public abstract class BaseWeekView extends com.chungld.uipack.calendar.BaseView {
     ...
     */
    final void setup(TrpCalendar calendar) {
        mItems = com.chungld.uipack.calendar.CalendarUtil.initCalendarForWeekView(calendar, mDelegate, mDelegate.getWeekStart());
        addSchemesFromMap();
        invalidate();
    }
     ...
     * @param calendar calendar
     */
    final void setSelectedCalendar(TrpCalendar calendar) {
     ...
     */
    final void performClickCalendar(TrpCalendar calendar, boolean isNotice) {
        ...
        int week = com.chungld.uipack.calendar.CalendarUtil.getWeekViewIndexFromCalendar(calendar, mDelegate.getWeekStart());
        if (mItems.contains(mDelegate.getCurrentDay())) {
            week = com.chungld.uipack.calendar.CalendarUtil.getWeekViewIndexFromCalendar(mDelegate.getCurrentDay(), mDelegate.getWeekStart());
        }

        int curIndex = week;

        TrpCalendar currentCalendar = mItems.get(week);
        ...
        int i = com.chungld.uipack.calendar.CalendarUtil.getWeekFromDayInMonth(currentCalendar, mDelegate.getWeekStart());
     ...
     * @return 是否是最小访问边界了
     */
    final boolean isMinRangeEdge(TrpCalendar calendar) {
     ...
     * @return 获取点击的日历
     */
    protected TrpCalendar getIndex() {
    ...
    final void updateWeekStart() {
        ...
        TrpCalendar calendar = com.chungld.uipack.calendar.CalendarUtil.getFirstCalendarStartWithMinCalendar(mDelegate.getMinYear(),
