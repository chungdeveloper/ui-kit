...
public class CalendarView extends FrameLayout {
     ...
     * 抽取自定义属性
     */
    private final com.chungld.uipack.calendar.CalendarViewDelegate mDelegate;
     ...
     * 月份快速选取
     */
    private com.chungld.uipack.calendar.YearViewPager mYearViewPager;

    /**
     * 星期栏
     */
    private com.chungld.uipack.calendar.WeekBar mWeekBar;

    /**
     * 日历外部收缩布局
     */
    com.chungld.uipack.calendar.CalendarLayout mParentLayout;
    ...
    public CalendarView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mDelegate = new com.chungld.uipack.calendar.CalendarViewDelegate(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        try {
            ...
            mWeekBar = (com.chungld.uipack.calendar.WeekBar) constructor.newInstance(getContext());
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        params.setMargins(0, mDelegate.getWeekBarHeight() + com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 1), 0, 0);
        ...
        mDelegate.mInnerListener = new OnInnerDateSelectedListener() {
             ...
             */
            @Override
            public void onMonthDateSelected(TrpCalendar calendar, boolean isClick) {
                ...
                if (mDelegate.getSelectMode() == com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_DEFAULT || isClick) {
                    mDelegate.mSelectedCalendar = calendar;
                }
                mWeekPager.updateSelected(mDelegate.mIndexCalendar, false);
                mMonthPager.updateSelected();
                if (mWeekBar != null &&
                        (mDelegate.getSelectMode() == com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_DEFAULT || isClick)) {
             ...
             */
            @Override
            public void onWeekDateSelected(TrpCalendar calendar, boolean isClick) {
                mDelegate.mIndexCalendar = calendar;
                if (mDelegate.getSelectMode() == com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_DEFAULT || isClick
                ...
                mMonthPager.updateSelected();
                if (mWeekBar != null &&
                        (mDelegate.getSelectMode() == com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_DEFAULT
                                || isClick
                                || mDelegate.mIndexCalendar.equals(mDelegate.mSelectedCalendar))) {
                    mWeekBar.onDateSelected(calendar, mDelegate.getWeekStart(), isClick);
                }
        ...
        if (mDelegate.getSelectMode() == com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_DEFAULT) {
            ...
            mDelegate.mSelectedCalendar = new TrpCalendar();
        }
        ...
        mYearViewPager.setOnMonthSelectedListener(new com.chungld.uipack.calendar.YearRecyclerView.OnMonthSelectedListener() {
            @Override
    ...
    public void setRange(int minYear, int minYearMonth, int minYearDay,
        ...
        if (com.chungld.uipack.calendar.CalendarUtil.compareTo(minYear, minYearMonth, minYearDay,
    ...
    private void closeSelectLayout(final int position) {
        ...
        if (position == mMonthPager.getCurrentItem()) {
            if (mDelegate.mCalendarSelectListener != null &&
                    mDelegate.getSelectMode() != com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_SINGLE) {
    ...
    public void scrollToCurrent(boolean smoothScroll) {
        ...
        TrpCalendar calendar = mDelegate.createCurrentDate();
    ...
    public final void setDefaultMonthViewSelectDay() {
        mDelegate.setDefaultCalendarSelectDay(com.chungld.uipack.calendar.CalendarViewDelegate.FIRST_DAY_OF_MONTH);
    }

    public final void setLastMonthViewSelectDay() {
        mDelegate.setDefaultCalendarSelectDay(com.chungld.uipack.calendar.CalendarViewDelegate.LAST_MONTH_VIEW_SELECT_DAY);
    }

    public final void setLastMonthViewSelectDayIgnoreCurrent() {
        mDelegate.setDefaultCalendarSelectDay(com.chungld.uipack.calendar.CalendarViewDelegate.LAST_MONTH_VIEW_SELECT_DAY_IGNORE_CURRENT);
    }
     ...
     */
    public final void putMultiSelect(TrpCalendar... calendars) {
        if (calendars == null || calendars.length == 0) {
            return;
        }
        for (TrpCalendar calendar : calendars) {
    ...
    public final void removeMultiSelect(TrpCalendar... calendars) {
        if (calendars == null || calendars.length == 0) {
            return;
        }
        for (TrpCalendar calendar : calendars) {
    ...
    public final List<TrpCalendar> getMultiSelectCalendars() {
     ...
     * @return return
     */
    public final List<TrpCalendar> getSelectCalendarRange() {
    ...
    public final void setOnCalendarInterceptListener(OnCalendarInterceptListener listener) {
        ...
        if (listener == null || mDelegate.getSelectMode() == com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_DEFAULT) {
            return;
        }
    ...
    public final void setSelectStartCalendar(int startYear, int startMonth, int startDay) {
        if (mDelegate.getSelectMode() != com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_RANGE) {
            return;
        }
        TrpCalendar startCalendar = new TrpCalendar();
    ...
    public final void setSelectStartCalendar(TrpCalendar startCalendar) {
        if (mDelegate.getSelectMode() != com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_RANGE) {
            return;
        }
    ...
    public final void setSelectEndCalendar(int endYear, int endMonth, int endDay) {
        ...
        TrpCalendar endCalendar = new TrpCalendar();
    ...
    public final void setSelectEndCalendar(TrpCalendar endCalendar) {
        if (mDelegate.getSelectMode() != com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_RANGE) {
            return;
        }
        if (mDelegate.mSelectedStartRangeCalendar == null) {
     ...
     */
    public final void setSelectCalendarRange(TrpCalendar startCalendar, TrpCalendar endCalendar) {
     ...
     * @return 是否拦截日期
     */
    protected final boolean onCalendarIntercept(TrpCalendar calendar) {
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        mDelegate.mSelectedCalendar = (TrpCalendar) bundle.getSerializable("selected_calendar");
        mDelegate.mIndexCalendar = (TrpCalendar) bundle.getSerializable("index_calendar");
        if (mDelegate.mCalendarSelectListener != null) {
            mDelegate.mCalendarSelectListener.onCalendarSelect(mDelegate.mSelectedCalendar, false);
        }
    ...
    protected void onAttachedToWindow() {
        ...
        if (getParent() != null && getParent() instanceof com.chungld.uipack.calendar.CalendarLayout) {
            mParentLayout = (com.chungld.uipack.calendar.CalendarLayout) getParent();
     ...
     */
    public final void setSchemeDate(Map<String, TrpCalendar> mSchemeDates) {
     ...
     * @param calendar calendar
     */
    public final void addSchemeDate(TrpCalendar calendar) {
     ...
     */
    public final void addSchemeDate(Map<String, TrpCalendar> mSchemeDates) {
     ...
     * @param calendar calendar
     */
    public final void removeSchemeDate(TrpCalendar calendar) {
        if (calendar == null) {
            return;
        }
     ...
     */
    public void setSelectedColor(int selectedThemeColor, int selectedRangeColor, int selectedTextColor, int selectedLunarTextColor) {
        if (mDelegate == null || mMonthPager == null || mWeekPager == null) {
            return;
        }
        mDelegate.setSelectColor(selectedThemeColor, selectedRangeColor, selectedTextColor, selectedLunarTextColor);
        mMonthPager.updateStyle();
        mWeekPager.updateStyle();
    }
     ...
     */
    public void setThemeColor(int selectedThemeColor, int selectedRangeColor, int schemeColor) {
        if (mDelegate == null || mMonthPager == null || mWeekPager == null) {
            return;
        }
        mDelegate.setThemeColor(selectedThemeColor, selectedRangeColor, schemeColor);
        mMonthPager.updateStyle();
        mWeekPager.updateStyle();
    }
    ...
    public final void setSelectDefaultMode() {
        ...
        mDelegate.setSelectMode(com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_DEFAULT);
        mWeekBar.onDateSelected(mDelegate.mSelectedCalendar, mDelegate.getWeekStart(), false);
    ...
    public void setSelectRangeMode() {
        ...
        mDelegate.setSelectMode(com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_RANGE);
        clearSelectRange();
    }
    ...
    public void setSelectMultiMode() {
        if (mDelegate.getSelectMode() == com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_MULTI) {
            return;
        }
        mDelegate.setSelectMode(com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_MULTI);
        clearMultiSelect();
    }
    ...
    public void setSelectSingleMode() {
        if (mDelegate.getSelectMode() == com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_SINGLE) {
            return;
        }
        mDelegate.setSelectMode(com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_SINGLE);
    ...
    public void setWeekStarWithSun() {
        setWeekStart(com.chungld.uipack.calendar.CalendarViewDelegate.WEEK_START_WITH_SUN);
    }
    ...
    public void setWeekStarWithMon() {
        setWeekStart(com.chungld.uipack.calendar.CalendarViewDelegate.WEEK_START_WITH_MON);
    }
    ...
    public void setWeekStarWithSat() {
        setWeekStart(com.chungld.uipack.calendar.CalendarViewDelegate.WEEK_START_WITH_SAT);
    }
    ...
    private void setWeekStart(int weekStart) {
        if (weekStart != com.chungld.uipack.calendar.CalendarViewDelegate.WEEK_START_WITH_SUN &&
                weekStart != com.chungld.uipack.calendar.CalendarViewDelegate.WEEK_START_WITH_MON &&
                weekStart != com.chungld.uipack.calendar.CalendarViewDelegate.WEEK_START_WITH_SAT)
            return;
    ...
    public boolean isSingleSelectMode() {
        return mDelegate.getSelectMode() == com.chungld.uipack.calendar.CalendarViewDelegate.SELECT_MODE_SINGLE;
    }
    ...
    public void setAllMode() {
        setShowMode(com.chungld.uipack.calendar.CalendarViewDelegate.MODE_ALL_MONTH);
    }
    ...
    public void setOnlyCurrentMode() {
        setShowMode(com.chungld.uipack.calendar.CalendarViewDelegate.MODE_ONLY_CURRENT_MONTH);
    }
    ...
    public void setFixMode() {
        setShowMode(com.chungld.uipack.calendar.CalendarViewDelegate.MODE_FIT_MONTH);
    }
    ...
    private void setShowMode(int mode) {
        if (mode != com.chungld.uipack.calendar.CalendarViewDelegate.MODE_ALL_MONTH &&
                mode != com.chungld.uipack.calendar.CalendarViewDelegate.MODE_ONLY_CURRENT_MONTH &&
                mode != com.chungld.uipack.calendar.CalendarViewDelegate.MODE_FIT_MONTH)
            return;
     ...
     * @return 获取当前周数据
     */
    public List<TrpCalendar> getCurrentWeekCalendars() {
     ...
     * @return 获取选择的日期
     */
    public TrpCalendar getSelectedCalendar() {
     ...
     * @return 最小范围日期
     */
    public TrpCalendar getMinRangeCalendar() {
     ...
     * @return 最大范围日期
     */
    public TrpCalendar getMaxRangeCalendar() {
     ...
     * @return 获得月视图
     */
    public com.chungld.uipack.calendar.MonthViewPager getMonthViewPager() {
        return mMonthPager;
    }
     ...
     * @return 获得周视图
     */
    public com.chungld.uipack.calendar.WeekViewPager getWeekViewPager() {
        return mWeekPager;
    }
     ...
     * @return 是否在日期范围内
     */
    protected final boolean isInRange(TrpCalendar calendar) {
        return mDelegate != null && com.chungld.uipack.calendar.CalendarUtil.isCalendarInRange(calendar, mDelegate);
    }
    ...
    public interface OnWeekChangeListener {
        void onWeekChange(List<TrpCalendar> weekCalendars);
    }
    ...
    interface OnInnerDateSelectedListener {
         ...
         * @param isClick  是否是点击
         */
        void onMonthDateSelected(TrpCalendar calendar, boolean isClick);
         ...
         * @param isClick  是否是点击
         */
        void onWeekDateSelected(TrpCalendar calendar, boolean isClick);
    }
    ...
    public interface OnCalendarRangeSelectListener {
         ...
         * @param calendar calendar
         */
        void onCalendarSelectOutOfRange(TrpCalendar calendar);
         ...
         */
        void onSelectOutOfRange(TrpCalendar calendar, boolean isOutOfMinRange);
         ...
         * @param isEnd    是否结束
         */
        void onCalendarRangeSelect(TrpCalendar calendar, boolean isEnd);
    }
    ...
    public interface OnCalendarMultiSelectListener {
         ...
         * @param calendar calendar
         */
        void onCalendarMultiSelectOutOfRange(TrpCalendar calendar);
         ...
         * @param calendar calendar
         */
        void onMultiSelectOutOfSize(TrpCalendar calendar, int maxSize);
         ...
         */
        void onCalendarMultiSelect(TrpCalendar calendar, int curSize, int maxSize);
    }
    ...
    public interface OnCalendarSelectListener {
         ...
         * @param calendar calendar
         */
        void onCalendarOutOfRange(TrpCalendar calendar);
         ...
         */
        void onCalendarSelect(TrpCalendar calendar, boolean isClick);
    }
    ...
    public interface OnCalendarLongClickListener {
         ...
         * @param calendar calendar
         */
        void onCalendarLongClickOutOfRange(TrpCalendar calendar);
         ...
         * @param calendar calendar
         */
        void onCalendarLongClick(TrpCalendar calendar);
    }
    ...
    public interface OnCalendarInterceptListener {
        boolean onCalendarIntercept(TrpCalendar calendar);

        void onCalendarInterceptClick(TrpCalendar calendar, boolean isClick);
    }
}
