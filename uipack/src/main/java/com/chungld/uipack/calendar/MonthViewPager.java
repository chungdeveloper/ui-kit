...
public final class MonthViewPager extends ViewPager {
    ...
    private void init() {
        ...
        addOnPageChangeListener(new OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                TrpCalendar calendar = CalendarUtil.getFirstCalendarFromMonthViewPager(position, mDelegate);
     ...
     * @return 获取当前月份数据
     */
    List<TrpCalendar> getCurrentMonthCalendars() {
    ...
    private final class MonthViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            view.mMonthViewPager = com.chungld.uipack.calendar.MonthViewPager.this;
