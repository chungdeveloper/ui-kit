...
public class HuntTicketMonthView extends MonthView {
    ...
    protected void onDrawText(Canvas canvas, TrpCalendar calendar, int x, int y, boolean hasScheme, boolean isSelected) {
        ...
        if (isSelected) {
            ...
            drawPriceHunt(canvas, cx, y, mSelectedLunarTextPaint, isSelected, true, calendar);
        } else {
            ...
            drawPriceHunt(canvas, cx, y, calendar.isCurrentMonth() && isEnable && isInRange ?
                    mCurMonthLunarTextPaint : mOtherMonthLunarTextPaint, isSelected, isInRange, calendar);
        }
    }
    ...
    private void drawPriceHunt(Canvas canvas, int cx, int y, Paint paint, boolean isSelected, boolean isInRange, TrpCalendar calendar) {
        ...
        paint.setColor(isSelected ? 0xffffffff : getColorPrice(dateFormatted, price));
