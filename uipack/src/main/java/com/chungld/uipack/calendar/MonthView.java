 ...
 */
public abstract class MonthView extends com.chungld.uipack.calendar.BaseMonthView {
     ...
     * @param d        d
     */
    private void draw(Canvas canvas, TrpCalendar calendar, int i, int j, int d) {
        int x = j * mItemWidth + mDelegate.getCalendarPadding();
        int y = i * mItemHeight;
        onLoopStart(x, y);
        boolean isSelected = calendar.compareTo(mDelegate.mSelectedCalendar) == 0;//d == mCurrentItem;
    ...
    public void onClick(View v) {
        ...
        if (mParentLayout != null) {
            if (calendar.isCurrentMonth()) {
                ...
                mParentLayout.updateSelectWeek(com.chungld.uipack.calendar.CalendarUtil.getWeekFromDayInMonth(calendar, mDelegate.getWeekStart()));
            }
     ...
     * @param y        日历Card y起点坐标
     */
    protected abstract void onDrawScheme(Canvas canvas, TrpCalendar calendar, int x, int y);
