...
import com.chungld.uipack.calendar.model.AdditionData;
...
final class CalendarViewDelegate {
     ...
     * 标记的主题色和选中的主题色
     */
    private int mSchemeThemeColor, mSelectedThemeColor, mSelectedRangeThemeColor;
     ...
     * 今天的日子
     */
    private TrpCalendar mCurrentDate;
     ...
     * 标记的日期,数量巨大，请使用这个
     */
    Map<String, TrpCalendar> mSchemeDatesMap;
     ...
     * 保存选中的日期
     */
    TrpCalendar mSelectedCalendar;

    /**
     * 保存标记位置
     */
    TrpCalendar mIndexCalendar;

    /**
     * 多选日历
     */
    Map<String, TrpCalendar> mSelectedCalendars = new HashMap<>();
     ...
     * 选择范围日历
     */
    TrpCalendar mSelectedStartRangeCalendar, mSelectedEndRangeCalendar;
    ...
    CalendarViewDelegate(Context context, @Nullable AttributeSet attrs) {
        ...
        com.chungld.uipack.calendar.LunarCalendar.init(context);
        ...
        mWeekTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_week_text_size,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 12));
        mWeekBarHeight = (int) array.getDimension(R.styleable.CalendarView_week_bar_height,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 40));
        mWeekLineMargin = (int) array.getDimension(R.styleable.CalendarView_week_line_margin,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 0));
        ...
        mSelectedRangeThemeColor = array.getColor(R.styleable.CalendarView_selected_range_theme_color, 0x50CFCFCF);
        ...
        mDayTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_day_text_size,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 16));
        mLunarTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_lunar_text_size,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 10));
        mCalendarItemHeight = (int) array.getDimension(R.styleable.CalendarView_calendar_height,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 56));
        ...
        mYearViewMonthTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_year_view_month_text_size,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 18));
        mYearViewDayTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_year_view_day_text_size,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 7));
        ...
        mYearViewWeekTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_year_view_week_text_size,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 8));
        mYearViewMonthHeight = array.getDimensionPixelSize(R.styleable.CalendarView_year_view_month_height,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 32));
        ...
        mYearViewPadding = (int) array.getDimension(R.styleable.CalendarView_year_view_padding,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 6));
        mYearViewMonthMarginTop = (int) array.getDimension(R.styleable.CalendarView_year_view_month_margin_top,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 4));
    ...
    CalendarViewDelegate(Context context, @Nullable AttributeSet attrs, boolean isVertical) {
        TypedArray array = context.obtainStyledAttributes(attrs, isVertical ? R.styleable.CalendarVerticalView : R.styleable.CalendarView);

        com.chungld.uipack.calendar.LunarCalendar.init(context);

        mCalendarPadding = (int) array.getDimension(R.styleable.CalendarVerticalView_calendar_padding, 0);
        mSchemeTextColor = array.getColor(R.styleable.CalendarVerticalView_scheme_text_color, 0xFFFFFFFF);
        mSchemeLunarTextColor = array.getColor(R.styleable.CalendarVerticalView_scheme_lunar_text_color, 0xFFe1e1e1);
        mSchemeThemeColor = array.getColor(R.styleable.CalendarVerticalView_scheme_theme_color, 0x50CFCFCF);
        mMonthViewClassPath = array.getString(R.styleable.CalendarVerticalView_month_view);
        mYearViewClassPath = array.getString(R.styleable.CalendarVerticalView_year_view);
        mWeekViewClassPath = array.getString(R.styleable.CalendarVerticalView_week_view);
        mWeekBarClassPath = array.getString(R.styleable.CalendarVerticalView_week_bar_view);
        mWeekTextSize = array.getDimensionPixelSize(R.styleable.CalendarVerticalView_week_text_size,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 12));
        mWeekBarHeight = (int) array.getDimension(R.styleable.CalendarVerticalView_week_bar_height,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 40));
        mWeekLineMargin = (int) array.getDimension(R.styleable.CalendarVerticalView_week_line_margin,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 0));

        mSchemeText = array.getString(R.styleable.CalendarVerticalView_scheme_text);
        if (TextUtils.isEmpty(mSchemeText)) {
            mSchemeText = "记";
        }

        mMonthViewScrollable = array.getBoolean(R.styleable.CalendarVerticalView_month_view_scrollable, true);
        mWeekViewScrollable = array.getBoolean(R.styleable.CalendarVerticalView_week_view_scrollable, true);
        mYearViewScrollable = array.getBoolean(R.styleable.CalendarVerticalView_year_view_scrollable, true);

        mDefaultCalendarSelectDay = array.getInt(R.styleable.CalendarVerticalView_month_view_auto_select_day,
                FIRST_DAY_OF_MONTH);

        mMonthViewShowMode = array.getInt(R.styleable.CalendarVerticalView_month_view_show_mode, MODE_ALL_MONTH);
        mWeekStart = array.getInt(R.styleable.CalendarVerticalView_week_start_with, WEEK_START_WITH_SUN);
        mSelectMode = array.getInt(R.styleable.CalendarVerticalView_select_mode, SELECT_MODE_DEFAULT);
        mMaxMultiSelectSize = array.getInt(R.styleable.CalendarVerticalView_max_multi_select_size, Integer.MAX_VALUE);
        mMinSelectRange = array.getInt(R.styleable.CalendarVerticalView_min_select_range, -1);
        mMaxSelectRange = array.getInt(R.styleable.CalendarVerticalView_max_select_range, -1);
        setSelectRange(mMinSelectRange, mMaxSelectRange);

        mWeekBackground = array.getColor(R.styleable.CalendarVerticalView_week_background, Color.WHITE);
        mWeekLineBackground = array.getColor(R.styleable.CalendarVerticalView_week_line_background, Color.TRANSPARENT);
        mYearViewBackground = array.getColor(R.styleable.CalendarVerticalView_year_view_background, Color.WHITE);
        mWeekTextColor = array.getColor(R.styleable.CalendarVerticalView_week_text_color, 0xFF333333);

        mCurDayTextColor = array.getColor(R.styleable.CalendarVerticalView_current_day_text_color, Color.RED);
        mCurDayLunarTextColor = array.getColor(R.styleable.CalendarVerticalView_current_day_lunar_text_color, Color.RED);

        mSelectedThemeColor = array.getColor(R.styleable.CalendarVerticalView_selected_theme_color, 0x50CFCFCF);
        mSelectedRangeThemeColor = array.getColor(R.styleable.CalendarVerticalView_selected_range_theme_color, 0x50CFCFCF);
        mSelectedTextColor = array.getColor(R.styleable.CalendarVerticalView_selected_text_color, 0xFF111111);

        mSelectedLunarTextColor = array.getColor(R.styleable.CalendarVerticalView_selected_lunar_text_color, 0xFF111111);
        mCurrentMonthTextColor = array.getColor(R.styleable.CalendarVerticalView_current_month_text_color, 0xFF111111);
        mOtherMonthTextColor = array.getColor(R.styleable.CalendarVerticalView_other_month_text_color, 0xFFe1e1e1);

        mCurMonthLunarTextColor = array.getColor(R.styleable.CalendarVerticalView_current_month_lunar_text_color, 0xffe1e1e1);
        mOtherMonthLunarTextColor = array.getColor(R.styleable.CalendarVerticalView_other_month_lunar_text_color, 0xffe1e1e1);
        mMinYear = array.getInt(R.styleable.CalendarVerticalView_min_year, 1971);
        mMaxYear = array.getInt(R.styleable.CalendarVerticalView_max_year, 2055);
        mMinYearMonth = array.getInt(R.styleable.CalendarVerticalView_min_year_month, 1);
        mMaxYearMonth = array.getInt(R.styleable.CalendarVerticalView_max_year_month, 12);
        mMinYearDay = array.getInt(R.styleable.CalendarVerticalView_min_year_day, 1);
        mMaxYearDay = array.getInt(R.styleable.CalendarVerticalView_max_year_day, -1);

        mDayTextSize = array.getDimensionPixelSize(R.styleable.CalendarVerticalView_day_text_size,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 16));
        mLunarTextSize = array.getDimensionPixelSize(R.styleable.CalendarVerticalView_lunar_text_size,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 10));
        mCalendarItemHeight = (int) array.getDimension(R.styleable.CalendarVerticalView_calendar_height,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 56));
        isFullScreenCalendar = array.getBoolean(R.styleable.CalendarVerticalView_calendar_match_parent, false);

        //年视图相关
        mYearViewMonthTextSize = array.getDimensionPixelSize(R.styleable.CalendarVerticalView_year_view_month_text_size,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 18));
        mYearViewDayTextSize = array.getDimensionPixelSize(R.styleable.CalendarVerticalView_year_view_day_text_size,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 7));
        mYearViewMonthTextColor = array.getColor(R.styleable.CalendarVerticalView_year_view_month_text_color, 0xFF111111);
        mYearViewDayTextColor = array.getColor(R.styleable.CalendarVerticalView_year_view_day_text_color, 0xFF111111);
        mYearViewSchemeTextColor = array.getColor(R.styleable.CalendarVerticalView_year_view_scheme_color, mSchemeThemeColor);
        mYearViewWeekTextColor = array.getColor(R.styleable.CalendarVerticalView_year_view_week_text_color, 0xFF333333);
        mYearViewCurDayTextColor = array.getColor(R.styleable.CalendarVerticalView_year_view_current_day_text_color, mCurDayTextColor);
        mYearViewSelectTextColor = array.getColor(R.styleable.CalendarVerticalView_year_view_select_text_color, 0xFF333333);
        mYearViewWeekTextSize = array.getDimensionPixelSize(R.styleable.CalendarVerticalView_year_view_week_text_size,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 8));
        mYearViewMonthHeight = array.getDimensionPixelSize(R.styleable.CalendarVerticalView_year_view_month_height,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 32));
        mYearViewWeekHeight = array.getDimensionPixelSize(R.styleable.CalendarVerticalView_year_view_week_height,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 0));

        mYearViewPadding = (int) array.getDimension(R.styleable.CalendarVerticalView_year_view_padding,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 6));
        mYearViewMonthMarginTop = (int) array.getDimension(R.styleable.CalendarVerticalView_year_view_month_margin_top,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 4));
        mYearViewMonthMarginBottom = (int) array.getDimension(R.styleable.CalendarVerticalView_year_view_month_margin_bottom,
                com.chungld.uipack.calendar.CalendarUtil.dipToPx(context, 4));
    ...
    private void init() {
        mCurrentDate = new TrpCalendar();
        Date d = new Date();
        mCurrentDate.setYear(com.chungld.uipack.calendar.CalendarUtil.getDate("yyyy", d));
        mCurrentDate.setMonth(com.chungld.uipack.calendar.CalendarUtil.getDate("MM", d));
        mCurrentDate.setDay(com.chungld.uipack.calendar.CalendarUtil.getDate("dd", d));
        mCurrentDate.setCurrentDay(true);
        com.chungld.uipack.calendar.LunarCalendar.setupLunarCalendar(mCurrentDate);
        setRange(mMinYear, mMinYearMonth, mMaxYear, mMaxYearMonth);

        try {
            mWeekBarClass = TextUtils.isEmpty(mWeekBarClassPath) ?
                    mWeekBarClass = com.chungld.uipack.calendar.WeekBar.class : Class.forName(mWeekBarClassPath);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            mYearViewClass = TextUtils.isEmpty(mYearViewClassPath) ?
                    mYearViewClass = com.chungld.uipack.calendar.DefaultYearView.class : Class.forName(mYearViewClassPath);
        } catch (Exception e) {
            e.printStackTrace();
        }
        try {
        ...
        try {
            mWeekViewClass = TextUtils.isEmpty(mWeekViewClassPath) ?
                    com.chungld.uipack.calendar.DefaultWeekView.class : Class.forName(mWeekViewClassPath);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void setRange(int minYear, int minYearMonth,
        ...
        if (this.mMaxYearDay == -1) {
            this.mMaxYearDay = com.chungld.uipack.calendar.CalendarUtil.getMonthDaysCount(this.mMaxYear, mMaxYearMonth);
        }
...
//        }
    ...
    public int getSelectedRangeThemeColor() {
        return mSelectedRangeThemeColor;
    }
    ...
    void setSelectColor(int selectedColor, int selectedRangeColor, int selectedTextColor, int selectedLunarTextColor) {
        ...
        this.mSelectedRangeThemeColor = selectedRangeColor;
    }

    void setThemeColor(int selectedThemeColor, int selectedRangeColor, int schemeColor) {
    ...
    void clearSelectedScheme() {
        if (mSelectedCalendar != null) mSelectedCalendar.clearScheme();
    }
    ...
    final void updateSelectCalendarScheme() {
        if (mSchemeDatesMap != null && mSchemeDatesMap.size() > 0) {
            ...
            if (mSchemeDatesMap.containsKey(key)) {
                TrpCalendar d = mSchemeDatesMap.get(key);
    ...
    final void updateCalendarScheme(TrpCalendar targetCalendar) {
    ...
    TrpCalendar createCurrentDate() {
        TrpCalendar calendar = new TrpCalendar();
        ...
        com.chungld.uipack.calendar.LunarCalendar.setupLunarCalendar(calendar);
        return calendar;
    }

    final TrpCalendar getMinRangeCalendar() {
        TrpCalendar calendar = new TrpCalendar();
    ...
    final TrpCalendar getMaxRangeCalendar() {
        TrpCalendar calendar = new TrpCalendar();
     ...
     * 添加事件标记，来自Map
     */
    final void addSchemesFromMap(List<TrpCalendar> mItems) {
        if (mSchemeDatesMap == null || mSchemeDatesMap.size() == 0) {
            return;
        }
        for (TrpCalendar a : mItems) {
            if (mSchemeDatesMap.containsKey(a.toString())) {
                TrpCalendar d = mSchemeDatesMap.get(a.toString());
                if (d == null) {
                    continue;
                }
     ...
     */
    final void addSchemes(Map<String, TrpCalendar> mSchemeDates) {
        ...
        for (String key : mSchemeDates.keySet()) {
            ...
            TrpCalendar calendar = mSchemeDates.get(key);
            if (calendar == null) {
                continue;
            }
     ...
     * @return 选中范围
     */
    final List<TrpCalendar> getSelectCalendarRange() {
        if (mSelectMode != SELECT_MODE_RANGE) {
            return null;
        }
        List<TrpCalendar> calendars = new ArrayList<>();
