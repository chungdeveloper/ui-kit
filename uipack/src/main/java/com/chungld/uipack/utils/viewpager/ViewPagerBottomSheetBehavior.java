...
package com.chungld.uipack.utils.viewpager;
...
public class ViewPagerBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public float getmMaximumVelocity() {
        return mMaximumVelocity;
    }

    public void setmMaximumVelocity(float mMaximumVelocity) {
        this.mMaximumVelocity = mMaximumVelocity;
    }

    public int getmPeekHeight() {
        return mPeekHeight;
    }
    ...
    public boolean ismPeekHeightAuto() {
        return mPeekHeightAuto;
    }

    public void setmPeekHeightAuto(boolean mPeekHeightAuto) {
        this.mPeekHeightAuto = mPeekHeightAuto;
    }

    public int getmPeekHeightMin() {
        return mPeekHeightMin;
    }

    public void setmPeekHeightMin(int mPeekHeightMin) {
        this.mPeekHeightMin = mPeekHeightMin;
    }
    ...
    public void setmMinOffset(int mMinOffset) {
    ...
    public void setmMaxOffset(int mMaxOffset) {
        this.mMaxOffset = mMaxOffset;
    }

    public boolean ismHideable() {
        return mHideable;
    }

    public void setmHideable(boolean mHideable) {
        this.mHideable = mHideable;
    }

    public boolean ismSkipCollapsed() {
        return mSkipCollapsed;
    }

    public void setmSkipCollapsed(boolean mSkipCollapsed) {
    ...
    public void setmViewDragHelper(ViewDragHelper mViewDragHelper) {
        this.mViewDragHelper = mViewDragHelper;
    }

    public boolean ismIgnoreEvents() {
        return mIgnoreEvents;
    }

    public void setmIgnoreEvents(boolean mIgnoreEvents) {
        this.mIgnoreEvents = mIgnoreEvents;
    }

    public boolean ismNestedScrolled() {
        return mNestedScrolled;
    }

    public void setmNestedScrolled(boolean mNestedScrolled) {
        this.mNestedScrolled = mNestedScrolled;
    }
    ...
    public void setmParentHeight(int mParentHeight) {
        this.mParentHeight = mParentHeight;
    }

    public WeakReference<V> getmViewRef() {
        return mViewRef;
    }

    public void setmViewRef(WeakReference<V> mViewRef) {
        this.mViewRef = mViewRef;
    }

    public WeakReference<View> getmNestedScrollingChildRef() {
        return mNestedScrollingChildRef;
    }

    public void setmNestedScrollingChildRef(WeakReference<View> mNestedScrollingChildRef) {
        this.mNestedScrollingChildRef = mNestedScrollingChildRef;
    }

    public BottomSheetCallback getmCallback() {
        return mCallback;
    }

    public void setmCallback(BottomSheetCallback mCallback) {
    ...
    public int getmInitialY() {
        return mInitialY;
    }

    public void setmInitialY(int mInitialY) {
        this.mInitialY = mInitialY;
    }

    public boolean ismTouchingScrollingChild() {
        return mTouchingScrollingChild;
    }

    public void setmTouchingScrollingChild(boolean mTouchingScrollingChild) {
        this.mTouchingScrollingChild = mTouchingScrollingChild;
    }

    public ViewDragHelper.Callback getmDragCallback() {
