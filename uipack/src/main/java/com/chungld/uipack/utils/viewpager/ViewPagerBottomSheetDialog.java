...
public class ViewPagerBottomSheetDialog extends AppCompatDialog {
    ...
    private OnContentViewCreatedListener onContentViewCreatedListener;

    public void setOnContentViewCreatedListener(OnContentViewCreatedListener onContentViewCreatedListener) {
        this.onContentViewCreatedListener = onContentViewCreatedListener;
    }
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        final FrameLayout container = (FrameLayout) View.inflate(getContext(),
                R.layout.trp_ui_design_view_pager_bottom_sheet_dialog, null);
        ...
        if (onContentViewCreatedListener != null) {
            onContentViewCreatedListener.onCreated();
        }
    ...
    public void setBehavior(ViewPagerBottomSheetBehavior<FrameLayout> behavior) {
    ...
    public interface OnContentViewCreatedListener {
        void onCreated();
    }
}
